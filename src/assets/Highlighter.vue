<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36" @click="updateCursor">
...
export default {
  ...
  computed: {
    ...
    marker () {
      ...
      //     return '#0000'
      // }
      return Object.keys(highlightColors).includes(this.color) ? highlightColors[this.color] : highlightColors.default
    }
  },

  methods: {
    ...mapMutations('content', ['setCursor', 'setHighlightColor']),
    updateCursor () {
      this.setCursor(this.cursor)
      this.setHighlightColor(this.marker)
